...
ActiveRecord::Schema.define(version: 20150920051944) do
  ...
  add_index "likings", ["likable_id", "likable_type"], name: "index_likings_on_likable_id_and_likable_type", using: :btree
